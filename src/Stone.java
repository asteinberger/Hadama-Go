...
public class Stone implements Comparable<Stone> {
	...
	public Stone(Board b) {
		this.board = b;
		this.color = -1;
	} // end constructor

	public Stone(Board b, int c) {
		this.board = b;
		this.color = c;
	} // end constructor

	public Stone(Board b, int c, Point l) {
		this.board = b;
		this.color = c;
		this.location = l;
	} // end constructor

	public Stone(Board b, Point l) {
		this.board = b;
		this.location = l;
		this.color = -1;
	} // end constructor
