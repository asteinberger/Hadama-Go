...
public class Board {
	...
	public void addStone(Stone s) {
		...
		if (l[0] == s.getColor()) {
			...
			if ((lc[0].getChainNum() != c.getChainNum())
					&& (this.getRealChainIndex(lc[0].getChainNum()) != -1))
				this.chains.remove(this.getRealChainIndex(lc[0].getChainNum()));
		...
		if (l[1] == s.getColor()) {
			...
			if ((lc[1].getChainNum() != c.getChainNum())
					&& (this.getRealChainIndex(lc[1].getChainNum()) != -1))
				this.chains.remove(this.getRealChainIndex(lc[1].getChainNum()));
		...
		if (l[2] == s.getColor()) {
			...
			if ((lc[2].getChainNum() != c.getChainNum())
					&& (this.getRealChainIndex(lc[2].getChainNum()) != -1))
				this.chains.remove(this.getRealChainIndex(lc[2].getChainNum()));
		...
		if (l[3] == s.getColor()) {
			...
			if ((lc[3].getChainNum() != c.getChainNum())
					&& (this.getRealChainIndex(lc[3].getChainNum()) != -1))
				this.chains.remove(this.getRealChainIndex(lc[3].getChainNum()));
	...
	public int getRealChainIndex(int indexFound) {
		int result = 0;
		for (int i = 0; i < this.chains.size(); i++) {
			if (indexFound == this.chains.get(i).getChainNum())
				return result;
			else
				result++;
		} // end for
	...
	public void printChains() {
		...
		for (int i = 0; i < this.chains.size(); i++) {
			System.out.println("*************");
			Chain c = this.chains.get(i);
			System.out.println("Chain " + c.getChainNum() + ": " + "isYan = "
